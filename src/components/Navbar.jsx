    ...
    <div className="navbar py-7">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between">
            ...
            <ul
                ...
                -translate-x-1/2 md:-translate-x-0 md:opacity-100 bg-white/30 backdrop-blur-md 
                p-4 rounded-br-2xl rounded-bl-2xl md:bg-transparent transition-all md:transition-none
